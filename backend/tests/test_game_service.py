...
class TestGameService:
    ...
    async def test_create_game(self, game_service):
    ...
    async def test_get_game(self, game_service):
        """Test getting a game"""
    ...
    async def test_get_nonexistent_game(self, game_service):
        """Test getting a non-existent game"""
        fake_id = uuid4()
        game = await game_service.get_game(fake_id)
        assert game is None
