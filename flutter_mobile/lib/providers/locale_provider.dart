...
class LocaleProvider extends ChangeNotifier {
  LocaleProvider(this._prefs) : _locale = _localeFromCode(_prefs.getString(_storageKey) ?? 'he');
  ...
  AppLocale get appLocale => _locale.languageCode == 'en' ? AppLocale.en : AppLocale.he;
